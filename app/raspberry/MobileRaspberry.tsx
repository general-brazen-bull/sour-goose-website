...
export default function RaspberryPage() {
  ...
  return (
    <main className="relative min-h-screen w-full bg-black text-white overflow-hidden">
      {/* ✅ CRITICAL: Prevent hidden menu panel from blocking taps on iOS */}
      <style jsx global>{`
      ...
      {/* ✅ FOREGROUND CONTENT LAYER (INTERACTIVE) */}
      <div className="relative z-10 pointer-events-auto">
        ...
        <section className="relative min-h-screen w-full bg-black flex flex-col items-center text-center px-6 pt-28">
          ...
          <div className="relative z-20 w-full max-w-md flex flex-col items-center pointer-events-auto">
            ...
            {/* ✅ CTA: Use real <a> for bulletproof tapping on iOS */}
            <a
        ...
        <div className="relative overflow-hidden">
          <div className="absolute inset-0 -z-20 bg-gradient-to-b from-black via-[#120000] to-black pointer-events-none" />
          <div
