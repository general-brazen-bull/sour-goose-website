     ...
     {showEther && (
      ...
      <section className="w-full pt-24 pb-16 flex flex-col items-center text-center px-6">
        ...
        >
          ...
          <h1 className="mt-6 text-6xl md:text-7xl font-bebas text-[#FF0000] tracking-wide">
            SOUR GOOSE RASPBERRY
          </h1>
...
>
      ...
      <section className="w-full py-16 px-8 max-w-4xl mx-auto text-center">
        <h2 className="text-4xl font-bebas text-[#FF0000] mb-6">
          TASTE NOTES
        </h2>

        <p className="text-lg text-gray-200 leading-relaxed">
          Sour Goose Raspberry hits with a bright burst of real fruit flavour —
          clean, sharp, and unapologetically bold. Tart raspberry upfront,
          smooth finish, and that signature Sour Goose kick.
        </p>

        <div className="mt-8 space-y-2 text-gray-300">
          <p>
            <span className="text-[#FF0000] font-bold">Ingredients:</span> Vodka, Real Raspberry Extract, Natural Flavour
          </p>
          <p>
            <span className="text-[#FF0000] font-bold">Notes:</span> Tart · Fruity · Clean Finish
          </p>
          <p>
            <span className="text-[#FF0000] font-bold">ABV:</span> 35%
          </p>
        </div>
      </section>
      ...
      <section className="w-full py-20 px-8 max-w-4xl mx-auto text-center">
        ...
        <p className="text-lg text-gray-300 leading-relaxed">
          Raspberry was born from pure chaos — a dare, a fruit basket, and a
          mission to make the tartest, juiciest, most dangerously drinkable
          flavour on the West Coast. No subtlety. No apologies. Just a full
          throttle raspberry blast crafted for people who don’t do boring.
        </p>
      </section>

      {/* CTA FOOTER (PRODUCT CTA) */}
      <section className="w-full py-20 bg-[#FF0000] text-black text-center px-6">
        <h3 className="text-4xl font-bebas mb-4">READY FOR THE RUSH?</h3>
        <a
  href="https://deepbluedistilleries.ca/product-tag/sour-goose/"
  target="_blank"
  rel="noopener noreferrer"
