...
export default function SalsaPage() {
  ...
  return (
    <main className="relative min-h-screen w-full bg-black text-white overflow-hidden">
      {/* 🔒 CRITICAL: prevent hidden menu panel from blocking taps */}
      <style jsx global>{`
      ...
      <div className="relative z-10 pointer-events-auto">
        ...
        {/* GoosePeek must NEVER intercept taps */}
        <div className="pointer-events-none">
          <GoosePeek />
        </div>

        {/* ================= MOBILE HERO ================= */}
        <section className="relative min-h-screen w-full flex flex-col items-center text-center px-6 pt-28">
          <div className="relative z-20 w-full max-w-md flex flex-col items-center pointer-events-auto">
            {/* HEADLINE */}
            <DecryptedText
              text="SOUR GOOSE"
              speed={120}
            ...
            <div
              className="w-full flex justify-center mb-6 whitespace-nowrap"
            ...
            >
              <DecryptedText
                ...
                animateOn="view"
                onFinish={() => {}}
                className="font-bebas text-[#8FC81C] tracking-wide text-[clamp(5rem,11vw,6.5rem)] leading-none"
                encryptedClassName="font-bebas text-[#8FC81C] tracking-wide text-[clamp(5rem,11vw,6.5rem)] leading-none"
              />
            </div>
            ...
            <p className="font-bebas text-[#FFFF00] tracking-wide text-[clamp(2.2rem,4.5vw,2rem)] leading-tight -mt-32 mb-8 max-w-sm">
              TANGY. ZESTY. A GREEN TWIST WITH ATTITUDE.
            </p>
            ...
            <a
              ...
              className="w-full flex justify-center mb-40 relative z-[9999] pointer-events-auto"
            >
              <span
                className="
                  w-[50vw]
        ...
        <div className="relative overflow-hidden">
          <div className="absolute inset-0 -z-20 bg-gradient-to-b from-black via-[#0e1406] to-black pointer-events-none" />
          <div
          ...
          <section className="w-full py-20 px-6">
            <div className="max-w-4xl mx-auto text-center text-gray-200 text-lg md:text-xl leading-relaxed space-y-10">
              <ScrollReveal baseOpacity={0} enableBlur blurStrength={20}>
                Sour Goose Salsa Verde is the bold green twist that brings pure vibrancy to the glass.
              </ScrollReveal>

              <ScrollReveal baseOpacity={0} enableBlur blurStrength={20}>
                Energetic, expressive, and unapologetically fresh — it’s built for cocktails that want attitude.
              </ScrollReveal>
            </div>
          </section>
          ...
          <section className="w-full py-20 px-6">
            <div className="max-w-4xl mx-auto">
              <ElectricBorder color="#8FC81C" speed={1.2} chaos={0.6} thickness={2}>
        ...
        <footer className="bg-black py-8 border-t border-sour-red relative z-10">
          <div className="max-w-md mx-auto px-6 text-center space-y-4">
            <div className="flex justify-center items-center gap-6">
              <a href="https://instagram.com/drinksourgoose" target="_blank" className="flex items-center gap-2 text-lightning-yellow hover:text-white">
                <Instagram size={18} />
                <span className="font-bebas-ui text-lg">@DRINKSOURGOOSE</span>
              </a>

              <a href="https://www.tiktok.com/@drinksourgoose" target="_blank" className="flex items-center gap-2 text-lightning-yellow hover:text-white">
            ...
            <div>
              <a href="https://deepbluedistilleries.ca" target="_blank" className="inline-flex items-center gap-2 text-lightning-yellow hover:text-white">
                <ExternalLink size={16} />
                <span className="font-bebas-ui text-lg">DEEPBLUEDISTILLERIES.CA</span>
              </a>
            </div>
