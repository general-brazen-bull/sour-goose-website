...
/>
      ...
      {/* HERO */}
      <section className="relative z-10 text-center pt-32 pb-20">
        <DecryptedText
          ...
          animateOn="view"
          className="text-5xl sm:text-6xl md:text-7xl font-bebas-ui text-lightning-yellow lightning-text"
          encryptedClassName="text-5xl sm:text-6xl md:text-7xl font-bebas-ui text-lightning-yellow"
        ...
        <p className="text-sour-red font-bebas-ui text-xl mt-2 tracking-wide">
          Drop us a line — we don’t bite (but our liqueur might).
        </p>
      </section>

      {/* BUSINESS INQUIRIES SECTION */}
      <section className="relative z-10 max-w-5xl mx-auto px-6 text-center mb-20">
      ...
      {/* SPOTLIGHT CARDS */}
      <section className="relative z-10 mt-10 px-6 max-w-6xl mx-auto grid md:grid-cols-2 gap-14">
        {/* Email */}
        <SpotlightCard
      ...
      {/* DISTILLERY SITE */}
      <section className="relative z-10 text-center mt-24 mb-32 px-6">
